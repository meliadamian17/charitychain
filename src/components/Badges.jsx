...
const Badges = () => {
    ...
    <p className={`${styles.mainSectionTitleText} bg-amber-100/70 pl-5 pr-5 rounded-full mt-0`}> <NumericFormat displayType="text" value={totalDonation.toFixed(2)} thousandSeparator={true} prefix='$'/></p>
    <p className={`${styles.subSectionSubText} mt-4`}>You place in the top <span className='bg-amber-100/70 pt-1 pb-1 pl-4 pr-3 rounded-full'>{ rank }</span>.</p>
    </> : <></>
